...
/**
 * An Interface describing the behaviour of a signable component by an wallet
 */
public interface Signable {

  /**
   * Method used for serializing the object in a JSON buffer to be ready for signing by a wallet
   *
   * @return - JSON buffer
