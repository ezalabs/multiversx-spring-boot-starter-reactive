package software.crldev.multiversxspringbootstarterreactive.domain.wallet;
...
import software.crldev.multiversxspringbootstarterreactive.domain.transaction.Signable;
...
import software.crldev.multiversxspringbootstarterreactive.error.exception.CannotSignTransactionException;
import software.crldev.multiversxspringbootstarterreactive.error.exception.PrivateKeyHexSizeException;
import software.crldev.multiversxspringbootstarterreactive.util.MnemonicsUtils;
import software.crldev.multiversxspringbootstarterreactive.util.PemUtils;
...
public class Wallet {
  ...
  /**
   * Method used for creating Wallet instance using private key from PEM file (File format)
   *
  ...
  /**
   * Method used for creating Wallet instance using private key from PEM file (FilePart format) Used in reactive file input
   *
   * @param pem - required PEM file
   * @return - an instance of Wallet
   */
  ...
  /**
   * Method used for creating Wallet instance using mnemonics
   *
  ...
  /**
   * Method used for signing a Signable object using Ed25519Signer
   *
