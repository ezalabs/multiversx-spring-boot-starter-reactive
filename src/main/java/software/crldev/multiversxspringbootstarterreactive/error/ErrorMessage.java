package software.crldev.multiversxspringbootstarterreactive.error;

import lombok.AllArgsConstructor;
import lombok.Getter;

/**
 * Enum containing error messages used in custom Exceptions
 *
...
public enum ErrorMessage {
  ...
  INVALID_PROXY_URL("Invalid Proxy URL: %s."),
  ...
  TOKEN_PROPERTY(
      "Invalid ESDT token properties. Must be canFreeze, canWipe, canPause, canChangeOwner, canUpgrade, canAddSpecialRoles, canTransferNFTCreateRole."),
  ...
  NFT_MEDIA_URI(
      "Invalid NFT media URI. File format can only be png, jpeg, jpg, gif, acc, flac, m4a, mp3, wav, mov, quicktime, mp4 and webm."),
