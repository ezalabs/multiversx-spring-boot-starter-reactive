...
public class PemUtils {
  ...
  /**
   * Method used for extracting the private key in hex format from a PEM file
   *
  ...
  /**
   * Method used for extracting the private key in hex format from a PEM file Used in reactive steam input
   *
