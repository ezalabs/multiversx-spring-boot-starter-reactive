...
class ESDTUriTest {
    ...
    void fromStringMeta_notJson() {
        assertThrows(IllegalArgumentException.class, () -> ESDTUri.fromString("https://host/storage/metadata.notJson", ESDTUri.Type.METADATA));
    }

    @Test
    void fromStringMedia_notSupported() {
        assertThrows(IllegalArgumentException.class, () -> ESDTUri.fromString("https://host/storage/image.another", ESDTUri.Type.MEDIA));
    }
}