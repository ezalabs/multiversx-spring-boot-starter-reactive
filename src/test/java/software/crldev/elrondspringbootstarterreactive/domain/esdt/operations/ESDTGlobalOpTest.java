...
import software.crldev.elrondspringbootstarterreactive.domain.esdt.ESDTGlobalOp.Type;
...
class ESDTGlobalOpTest {
    ...
    void pause() {
        ...
        assertEquals(Address.fromBech32(ESDTConstants.ESDT_ISSUER_BECH32_ADDRESS).getBech32(), req1.getReceiverAddress().getBech32());
